...
export type Get_Page_By_SlugQueryVariables = Exact<{
  slug: Scalars['String'];
}>;


export type Get_Page_By_SlugQuery = { __typename?: 'Query', page?: { __typename?: 'Page', id: string, slug: string, heading: string, body: { __typename?: 'RichText', html: string } } | null };

export type Get_PlacesQueryVariables = Exact<{
  first?: InputMaybe<Scalars['Int']>;
}>;
